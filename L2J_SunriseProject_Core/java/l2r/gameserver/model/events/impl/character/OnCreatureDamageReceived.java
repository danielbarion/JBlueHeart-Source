...
public class OnCreatureDamageReceived implements IBaseEvent
{
	...
	public OnCreatureDamageReceived(L2Character attacker, L2Character target, double damage, L2Skill skill, boolean crit, boolean damageOverTime, boolean isReflect)
	{
		_attacker = attacker;
		_target = target;
		_damage = damage;
