...
public final class SystemMessageId
{
	...
	/**
	 * ID: 110<br>
	 * Message: $s1â€™s effect can be felt.
	 */
	...
	/**
	 * ID: 1609<br>
	 * Message: War has already been declared against that clanâ€¦ but I'll make note that you really don't like them.
	 */
	...
	/**
	 * ID: 1623<br>
	 * Message: Make haste! We will be departing for Gludin Harbor shortlyâ€¦
	 */
	...
	/**
	 * ID: 2038<br>
	 * Message: Some Lineage II features have been limited for free trials. Trial accounts arenâ€™t allowed to drop items and/or Adena. To unlock all of the features of Lineage II, purchase the full version today.
	 */
	public static final SystemMessageId ACCOUNT_CANT_DROP_ITEMS = new SystemMessageId(2038);
	
	/**
	 * ID: 2039<br>
	 * Message: Some Lineage II features have been limited for free trials. Trial accounts arenâ€™t allowed to trade items and/or Adena. To unlock all of the features of Lineage II, purchase the full version today.
	 */
	...
	/**
	 * ID: 2041<br>
	 * Message: Some Lineage II features have been limited for free trials. Trial accounts arenâ€™t allowed to setup private stores. To unlock all of the features of Lineage II, purchase the full version today.
	 */
	...
	/**
	 * ID: 2044<br>
	 * Message: Some Lineage II features have been limited for free trials. Trial accounts arenâ€™t allowed to set up private manufacturing stores. To unlock all of the features of Lineage II, purchase the full version today.
	 */
	public static final SystemMessageId CANT_SETUP_PRIVATE_WORKSHOP = new SystemMessageId(2044);
	
	/**
	 * ID: 2045<br>
	 * Message: Some Lineage II features have been limited for free trials. Trial accounts arenâ€™t allowed to use private manufacturing stores. To unlock all of the features of Lineage II, purchase the full version today.
	 */
	public static final SystemMessageId CANT_USE_PRIVATE_WORKSHOP = new SystemMessageId(2045);
	
	/**
	 * ID: 2046<br>
	 * Message: Some Lineage II features have been limited for free trials. Trial accounts arenâ€™t allowed buy items from private stores. To unlock all of the features of Lineage II, purchase the full version today.
	 */
	public static final SystemMessageId CANT_USE_PRIVATE_STORES = new SystemMessageId(2046);
	
	/**
	 * ID: 2047<br>
	 * Message: Some Lineage II features have been limited for free trials. Trial accounts arenâ€™t allowed to access clan warehouses. To unlock all of the features of Lineage II, purchase the full version today.
	 */
