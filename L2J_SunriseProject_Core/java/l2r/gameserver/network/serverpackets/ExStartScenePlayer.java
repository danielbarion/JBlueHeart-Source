...
public class ExStartScenePlayer extends L2GameServerPacket
{
	...
	public static final int SCENE_TALKING_ISLAND_BOSS_OPENING = 43; // Quest start on the first profile
	public static final int SCENE_TALKING_ISLAND_BOSS_ENDING = 44; // The quest to finish the first profile
